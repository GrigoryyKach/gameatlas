    ...
    <div className="post container mx-auto flex gap-8 mb-14">
      ...
      <aside className="w-full md:w-1/4 flex-shrink-0">
        <div className="sticky top-20">
          ...
          <p className='text-[#BABABF]'><span className='font-bold text-white'>Разработчики:</span> {post.developers}</p>
          <p className='text-[#BABABF]'><span className='font-bold text-white'>Издатель:</span> {post.publisher}</p>
